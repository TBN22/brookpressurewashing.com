    ...
    $window.on("elementor/frontend/init", function() {
        ...
        var CountDown = function CountDown($scope) {
            ...
            $item.countdown({
                    ...
                    } else if ("url" === $end_action && $redirect_link !== undefined && $editor_mode_on !== !0) {
        ...
        var SliderBase = elementorModules.frontend.handlers.Base.extend({
            ...
            getReadySettings: function getReadySettings() {
                ...
                var settings = {
                    ...
                    loop: !!(this.getElementSettings("infinity_loop") || !1),
                ...
                if (this.getElementSettings("slider_type") == "multiple") {
                    ...
                    settings.customMultiple = !0
                }
                if (this.getElementSettings("autoplay") == "yes") {
                    settings.autoplay = {
                        delay: this.getElementSettings("autoplay_speed"),
                        disableOnInteraction: !1,
                        stopOnLastSlide: !(this.getElementSettings("infinity_loop") || !1)
                    }
                }
            ...
            run: function run() {
                ...
                if ("ha-horizontal" === image_align) {
                    ...
                    single_image_box.each(function() {
                        horizontal_align_width += $(this).outerWidth(!0)
                    });
                    items.css({
                ...
                if ("ha-vertical" === image_align) {
                    single_image_box.each(function() {
                        vertical_align_height += $(this).outerHeight(!0)
                    })
                }
                $.keyframe.define([{
                    name: scroll,
            ...
            tooltip_area.on({
                mouseenter: function mouseenter(e) {
                    var $this = $(this),
                        ...
                        tooltipW = tooltip.outerWidth(!0),
                        tooltipH = tooltip.outerHeight(!0),
        ...
        var TimeLine = function TimeLine($scope) {
            ...
            function scroll_tree() {
                timeline_block.each(function() {
                    var block_height = $(this).outerHeight(!0);
        ...
        var StickyVideo = function StickyVideo($scope) {
            ...
            playerAbc.on("play", function(e) {
                ...
                if (!0 === $settting.sticky) {
                    $window.on(event, function() {
                        var height = $box.outerHeight(!0);
                ...
                $.ajax({
                    ...
                    success: function success(response) {
                        if ($(response).length > 0) {
                            gridWrap.css("height", gridWrap.outerHeight(!0) + "px");
                            gridWrap.html("");
        ...
        var DataTable = function DataTable($scope) {
            ...
            var search = dataTable.data("search") == !0 ? !0 : !1;
            var paging = dataTable.data("paging") == !0 ? !0 : !1;
            var scrollX = dataTable.data("scroll-x") == undefined ? !1 : !0;
            ...
            if (dataTable.data("export-table") == !0) {
        ...
        OffCanvas.prototype = {
            ...
            init: function init() {
                ...
                if ($(".ha-offcanvas-container").length === 0) {
                    var faProJs = $("#font-awesome-pro-js").length > 0 ? $("#font-awesome-pro-js").attr("src") : !1;
                    if (faProJs) {
            ...
            _resize: function _resize() {
                ...
                if (off_canvas && off_canvas.length > 0) {
                    if (this.buttons_position === "bottom") {
                        ...
                        headerHeight = off_canvas.find(".ha-offcanvas-cart-header").outerHeight(!0);
        ...
        var Unfold = elementorModules.frontend.handlers.Base.extend({
            ...
            fold: function fold(unfoldData, button, collapse_height, unfoldRender) {
                ...
                unfoldData.css({
                    ...
                    "height": unfoldRender.outerHeight(!0) + 'px'
                });
                unfoldData.animate({
            ...
            unfold: function unfold(unfoldData, unfoldRender, button) {
                ...
                unfoldData.animate({
                    height: unfoldRender.outerHeight(!0)
                }, 0);
                var timeOut = setTimeout(function() {
        ...
        var HaTOC = elementorModules.frontend.handlers.Base.extend({
            ...
            getHeadingAnchorLink: function getHeadingAnchorLink(index, classes) {
                ...
                if (headingID || wrapperID) {
                    jQuery(this.elements.$headings[index]).data('hasOwnID', !0)
                } else {
