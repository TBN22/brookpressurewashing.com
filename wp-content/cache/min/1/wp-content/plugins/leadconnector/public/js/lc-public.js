(function() {
    ...
    window.addEventListener("load", function() {
        ...
        if (!lc_public_js || !lc_public_js.text_widget_location_id || lc_public_js.text_widget_error == "1") {
            console.error("invalid API key or location ID, please provide correct API key and resave it under LeadConnector setting menu");
            return
        }
        ...
        if (!!lc_public_js.text_widget_settings && !!(lc_public_js.text_widget_settings instanceof Object)) {
            ...
            for (var attrIndex = allAttrs.length - 1; attrIndex >= 0; attrIndex--) {
                try {
                    ...
                    if ("widget-primary-color" === attributeName) {
                        attributeName = "style";
                        attributeValue = "--chat-widget-primary-color:" + attributeValue + "; --chat-widget-active-color:" + attributeValue + " ;--chat-widget-bubble-color: " + attributeValue
                    }
                } catch (e) {
