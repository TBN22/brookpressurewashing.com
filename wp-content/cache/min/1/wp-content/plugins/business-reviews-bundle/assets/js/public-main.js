...
$jscomp.polyfill = function(b, e, g, k) {
    if (e) {
        ...
        k = g[b];
        e = e(k);
        e != k && null != e && $jscomp.defineProperty(g, b, {
            configurable: !0,
            writable: !0,
            value: e
        })
...
(function(b, e) {
    ...
    function k(b, f, e) {
        if (!m(b, e.successClass) && (f || e.loadInvisible || 0 < b.offsetWidth && 0 < b.offsetHeight))
            if (f = b.getAttribute(y) || b.getAttribute(e.src)) {
                f = f.split(e.separator);
                var l = f[E && 1 < f.length ? 1 : 0],
                    a = b.getAttribute(e.srcset),
    ...
    function u(b, c) {
        if (b && c)
            for (var f = b.length, e = 0; e < f && !1 !== c(b[e], e); e++);
    }
...
! function() {
    var b, e = function(q, m) {
        ...
        function f(a, h) {
            a = b(a.target);
            if (!a.is(h))
                if ("string" == typeof h) a = a.parents(h);
                else if (h.nodeType) {
                var d;
        ...
        function n(d) {
            ...
            if (!(d.shiftKey || d.altKey || d.ctrlKey || d.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textarea" === document.activeElement.nodeName.toLowerCase()))) {
                if (37 === b || 39 === b || 38 === b || 40 === b) {
                    ...
                    l = [
                        [l.left, l.top],
                        [l.left + a.width, l.top],
                        [l.left, l.top + a.height],
                        [l.left + a.width, l.top + a.height]
                    ];
                ...
                if (a.params.mousewheelInvert && (b = -b), a.params.freeMode) {
                    ...
                    if (60 < (new window.Date).getTime() - a.mousewheel.lastScrollTime)
                        if (0 > b)
                            ...
                            } else a.slideNext(), a.emit("onScroll", a, d);
        ...
        var x = {},
            r;
        for (r in m)
            if ("object" != typeof m[r] || null === m[r] || m[r].nodeType || m[r] === window || m[r] === document || void 0 !== g && m[r] instanceof g || "undefined" != typeof jQuery && m[r] instanceof jQuery) x[r] = m[r];
            else {
                x[r] = {};
                for (var G in m[r]) x[r][G] = m[r][G]
            }
        for (var v in w)
            if (void 0 === m[v]) m[v] = w[v];
            else if ("object" == typeof m[v])
            for (var P in w[v]) void 0 === m[v][P] && (m[v][P] = w[v][P]);
        var a = this;
        if (a.params = m, a.originalParams = x, a.classNames = [], void 0 !== b && void 0 !== g && (b = g), (void 0 !== b || (b = void 0 === g ? window.Dom7 || window.Zepto || window.jQuery : g)) && (a.$ = b, a.currentBreakpoint = void 0, a.getActiveBreakpoint = function() {
                ...
                if (d && a.currentBreakpoint !== d) {
                    var b = d in a.params.breakpoints ? a.params.breakpoints[d] : a.originalParams,
                        c = a.params.loop && b.slidesPerView !== a.params.slidesPerView,
                        f;
            ...
            a.updateAutoHeight = function() {
                ...
                if ("auto" !== a.params.slidesPerView && 1 < a.params.slidesPerView)
                    for (d = 0; d < Math.ceil(a.params.slidesPerView); d++) {
            ...
            a.updateSlidesSize = function() {
                ...
                a.slidesGrid = [];
                a.slidesSizesGrid = [];
                var b, h = a.params.spaceBetween,
                    c = -a.params.slidesOffsetBefore,
                    f = 0,
                    e = 0;
                if (void 0 !== a.size) {
                    ...
                    for (b = 0; b < a.slides.length; b++) {
                        ...
                        if (1 < a.params.slidesPerColumn) {
                            var p, t, u;
                            "column" === a.params.slidesPerColumnFill ? (t = Math.floor(b / g), u = b - t * g, (t > k || t === k && u === g - 1) && ++u >= g && (u = 0, t++), p = t + u * l / g, q.css({
                    ...
                    if (a.rtl && a.wrongRTL && ("slide" === a.params.effect || "coverflow" === a.params.effect) && a.wrapper.css({
                        ...
                        })), 1 < a.params.slidesPerColumn && (a.virtualSize = (m + a.params.spaceBetween) * l, a.virtualSize = Math.ceil(a.virtualSize / a.params.slidesPerColumn) - a.params.spaceBetween, a.isHorizontal() ? a.wrapper.css({
                            width: a.virtualSize + a.params.spaceBetween + "px"
                        }) : a.wrapper.css({
                            height: a.virtualSize + a.params.spaceBetween + "px"
            ...
            a.currentSlidesPerView = function() {
                ...
                if (a.params.centeredSlides) {
                    ...
                    for (b = a.activeIndex + 1; b < a.slides.length; b++) a.slidesGrid[b] - a.slidesGrid[a.activeIndex] < a.size && h++;
                return h
            };
                ...
                if (void 0 === b && (b = a.translate || 0), 0 !== a.slides.length) {
                    ...
                    for (b = 0; b < a.slides.length; b++) {
                        ...
                        if (a.params.watchSlidesVisibility) {
                            var e = -(d - c.rplgswSlideOffset),
                                l = e + a.slidesSizesGrid[b];
            ...
            a.updateClasses = function() {
                ...
                if (a.params.loop && 0 === d.length && (d = a.slides.eq(-1), d.addClass(a.params.slidePrevClass)), m.loop && (h.hasClass(a.params.slideDuplicateClass) ? a.wrapper.children("." + a.params.slideClass + ":not(." + a.params.slideDuplicateClass + ')[data-rplgsw-slide-index="' + h.attr("data-rplgsw-slide-index") + '"]').addClass(a.params.slideDuplicateNextClass) : a.wrapper.children("." + a.params.slideClass + "." + a.params.slideDuplicateClass + '[data-rplgsw-slide-index="' + h.attr("data-rplgsw-slide-index") + '"]').addClass(a.params.slideDuplicateNextClass), d.hasClass(a.params.slideDuplicateClass) ? a.wrapper.children("." + a.params.slideClass + ":not(." + a.params.slideDuplicateClass + ')[data-rplgsw-slide-index="' + d.attr("data-rplgsw-slide-index") + '"]').addClass(a.params.slideDuplicatePrevClass) : a.wrapper.children("." + a.params.slideClass + "." + a.params.slideDuplicateClass + '[data-rplgsw-slide-index="' + d.attr("data-rplgsw-slide-index") + '"]').addClass(a.params.slideDuplicatePrevClass)), a.paginationContainer && 0 < a.paginationContainer.length) {
                    ...
                    if (a.params.loop ? (c = Math.ceil((a.activeIndex - a.loopedSlides) / a.params.slidesPerGroup), c > a.slides.length - 1 - 2 * a.loopedSlides && (c -= a.slides.length - 2 * a.loopedSlides), c > h - 1 && (c -= h), 0 > c && "bullets" !== a.params.paginationType && (c = h + c)) : c = void 0 !== a.snapIndex ? a.snapIndex : a.activeIndex || 0, "bullets" === a.params.paginationType && a.bullets && 0 < a.bullets.length && (a.bullets.removeClass(a.params.bulletActiveClass), 1 < a.paginationContainer.length ? a.bullets.each(function() {
                        ...
                        a.paginationContainer.find("." + a.params.paginationProgressbarClass).transform("translate3d(0,0,0) scaleX(" + f + ") scaleY(" + e + ")").transition(a.params.speed)
                    }
            ...
            a.onResize = function(b) {
                ...
                var d = a.params.allowSwipeToPrev,
                    c = a.params.allowSwipeToNext;
            ...
            (window.navigator.pointerEnabled || window.navigator.msPointerEnabled) && ("container" === a.params.touchEventsTarget ? a.container : a.wrapper).addClass("rplgsw-wp8-" + a.params.direction);
            ...
            a.updateClickedSlide = function(d) {
                ...
                var h = !1;
                if (d)
                    for (var c = 0; c < a.slides.length; c++) a.slides[c] === d && (h = !0);
            ...
            var C, D, J, K, H, z, B, L, I, M, Q = Date.now(),
                F = [];
            a.animating = !1;
            a.touches = {
                startX: 0,
            ...
            a.onTouchMove = function(d) {
                if (d.originalEvent && (d = d.originalEvent), !N || "mousemove" !== d.type) {
                    ...
                    if (N && a.params.touchReleaseOnEdges && !a.params.loop)
                        if (a.isHorizontal()) {
                    ...
                    if (J && a.emit("onTouchMove", a, d), !(d.targetTouches && 1 < d.targetTouches.length)) {
                        ...
                        if (H && a.emit("onTouchMoveOpposite", a, d), void 0 === O && (a.touches.currentX === a.touches.startX && a.touches.currentY === a.touches.startY || (O = !0)), C) {
                            ...
                            if (O) {
                                ...
                                D = !0;
                                h = a.touches.diff = a.isHorizontal() ? a.touches.currentX - a.touches.startX : a.touches.currentY - a.touches.startY;
                ...
                if (d.originalEvent && (d = d.originalEvent), J && a.emit("onTouchEnd", a, d), J = !1, C) {
                    ...
                    if (h = a.params.followFinger ? a.rtl ? a.translate : -a.translate : -z, a.params.freeMode) {
                        ...
                        if (a.params.freeModeMomentum) {
                            ...
                            if (f < a.maxTranslate()) a.params.freeModeMomentumBounce ? (f + a.maxTranslate() < -g && (f = a.maxTranslate() - g), l = a.maxTranslate(), e = !0, M = !0) : f = a.maxTranslate();
                            else if (f > a.minTranslate()) a.params.freeModeMomentumBounce ? (f - a.minTranslate() > g && (f = a.minTranslate() + g), l = a.minTranslate(), e = !0, M = !0) : f = a.minTranslate();
                            ...
                            if (0 !== a.velocity) h = a.rtl ? Math.abs((-f - a.translate) / a.velocity) : Math.abs((f - a.translate) / a.velocity);
            ...
            a.slideTo = function(b, h, c, f) {
                ...
                if (a.params.autoplay && a.autoplaying && (f || !a.params.autoplayDisableOnInteraction ? a.pauseAutoplay(h) : a.stopAutoplay()), a.updateProgress(d), a.params.normalizeSlideIndex)
                    for (f = 0; f < a.slidesGrid.length; f++) - Math.floor(100 * d) >= Math.floor(100 * a.slidesGrid[f]) && (b = f);
            ...
            a.initObservers = function() {
                if (a.params.observeParents)
                    for (var b = a.container.parents(), h = 0; h < b.length; h++) l(b[h]);
                l(a.container[0], {
                    childList: !1
                });
                l(a.wrapper[0], {
            ...
            a.appendSlide = function(b) {
                if (a.params.loop && a.destroyLoop(), "object" == typeof b && b.length)
                    for (var d = 0; d < b.length; d++) b[d] && a.wrapper.append(b[d]);
            ...
            a.effects = {
                fade: {
                    setTranslate: function() {
                        for (var b = 0; b < a.slides.length; b++) {
                            var h = a.slides.eq(b),
                                c = -h[0].rplgswSlideOffset;
                            a.params.virtualTranslate || (c -= a.translate);
                            var f = 0;
                            a.isHorizontal() || (f = c, c = 0);
                            h.css({
                                opacity: a.params.fade.crossFade ? Math.max(1 - Math.abs(h[0].progress), 0) : 1 + Math.min(Math.max(h[0].progress, -1), 0)
                            }).transform("translate3d(" + c + "px, " + f + "px, 0px)")
                        }
                    },
                ...
                cube: {
                    setTranslate: function() {
                        var d, h = 0;
                        a.params.cube.shadow && (a.isHorizontal() ? (d = a.wrapper.find(".rplgsw-cube-shadow"), 0 === d.length && (d = b('<div class="rplgsw-cube-shadow"></div>'), a.wrapper.append(d)), d.css({
                            height: a.width + "px"
                        })) : (d = a.container.find(".rplgsw-cube-shadow"), 0 === d.length && (d = b('<div class="rplgsw-cube-shadow"></div>'), a.container.append(d))));
                ...
                coverflow: {
                    setTranslate: function() {
                        ...
                        for (var h = a.isHorizontal() ? a.params.coverflow.rotate : -a.params.coverflow.rotate, c = a.params.coverflow.depth, f = 0, e = a.slides.length; f < e; f++) {
                            var l = a.slides.eq(f),
                                g = a.slidesSizesGrid[f];
                            g = (d - l[0].rplgswSlideOffset - g / 2) / g * a.params.coverflow.modifier;
                            var n = a.isHorizontal() ? h * g : 0,
                                m = a.isHorizontal() ? 0 : h * g,
                                k = -c * Math.abs(g),
                                q = a.isHorizontal() ? 0 : a.params.coverflow.stretch * g,
                            ...
                            .001 > Math.abs(n) && (n = 0);
                            .001 > Math.abs(m) && (m = 0);
                            if (l.transform("translate3d(" + p + "px," + q + "px," + k + "px)  rotateX(" + m + "deg) rotateY(" + n + "deg)"), l[0].style.zIndex = 1 - Math.abs(Math.round(g)), a.params.coverflow.slideShadows) n = a.isHorizontal() ? l.find(".rplgsw-slide-shadow-left") : l.find(".rplgsw-slide-shadow-top"), m = a.isHorizontal() ? l.find(".rplgsw-slide-shadow-right") : l.find(".rplgsw-slide-shadow-bottom"), 0 === n.length && (n = b('<div class="rplgsw-slide-shadow-' + (a.isHorizontal() ? "left" : "top") + '"></div>'), l.append(n)), 0 === m.length && (m = b('<div class="rplgsw-slide-shadow-' + (a.isHorizontal() ? "right" : "bottom") + '"></div>'), l.append(m)), n.length && (n[0].style.opacity = 0 < g ? g : 0), m.length && (m[0].style.opacity = 0 < -g ? -g : 0)
                        }
            ...
            a.lazy = {
                ...
                loadImageInSlide: function(d, h) {
                    if (void 0 !== d && (void 0 === h && (h = !0), 0 !== a.slides.length)) {
                        ...
                        0 !== d.length && d.each(function() {
                            ...
                            var f = d.attr("data-background"),
                                e = d.attr("data-src"),
                                l = d.attr("data-srcset"),
                                g = d.attr("data-sizes");
                ...
                load: function() {
                    ...
                    if ("auto" === c && (c = 0), a.lazy.initialImageLoaded || (a.lazy.initialImageLoaded = !0), a.params.watchSlidesVisibility) a.wrapper.children("." + a.params.slideVisibleClass).each(function() {
                        ...
                        for (d = a.activeIndex; d < a.activeIndex + c; d++) a.slides[d] && a.lazy.loadImageInSlide(d);
                    ...
                    if (a.params.lazyLoadingInPrevNext)
                        if (1 < c || a.params.lazyLoadingInPrevNextAmount && 1 < a.params.lazyLoadingInPrevNextAmount) {
                            ...
                            var f = c,
                                e = Math.min(a.activeIndex + f + Math.max(d, f), a.slides.length);
                            f = Math.max(a.activeIndex - Math.max(f, d), 0);
                            for (d = a.activeIndex + c; d < e; d++) a.slides[d] && a.lazy.loadImageInSlide(d);
            ...
            a.scrollbar = {
                ...
                setDragPosition: function(b) {
                    ...
                    var c = -a.minTranslate() * d.moveDivider,
                        f = -a.maxTranslate() * d.moveDivider;
                    b < c ? b = c : b > f && (b = f);
                    b = -b / d.moveDivider;
                    a.updateProgress(b);
                ...
                enableDraggable: function() {
                    var d = a.scrollbar,
                        c = a.support.touch ? d.track : document;
                ...
                setTranslate: function() {
                    if (a.params.scrollbar) {
                        ...
                        a.rtl && a.isHorizontal() ? (f = -f, 0 < f ? (c = b.dragSize - f, f = 0) : -f + b.dragSize > b.trackSize && (c = b.trackSize + f)) : 0 > f ? (c = b.dragSize + f, f = 0) : f + b.dragSize > b.trackSize && (c = b.trackSize - f);
            ...
            a.controller = {
                ...
                setTranslate: function(b, c) {
                    ...
                    if (Array.isArray(l))
                        for (var g = 0; g < l.length; g++) l[g] !== c && l[g] instanceof e && d(l[g]);
                    else l instanceof e && c !== l && d(l)
                },
                setTransition: function(b, c) {
                    ...
                    if (Array.isArray(f))
                        for (h = 0; h < f.length; h++) f[h] !== c && f[h] instanceof
                    e && d(f[h]);
                    else f instanceof e && c !== f && d(f)
                }
            };
            a.hashnav = {
                ...
                init: function() {
                    if (a.params.hashnav && !a.params.history) {
                        ...
                        if (b)
                            for (var c = 0, f = a.slides.length; c < f; c++) {
                                var e = a.slides.eq(c);
            ...
            a.history = {
                ...
                scrollToSlide: function(b, c, f) {
                    if (c)
                        for (var d = 0, h = a.slides.length; d < h; d++) {
                            var e = a.slides.eq(d);
            ...
            a.parallax = {
                ...
                setTransition: function(d) {
                    ...
                    a.container.find("[data-rplgsw-parallax], [data-rplgsw-parallax-x], [data-rplgsw-parallax-y]").each(function() {
                        var a = b(this),
                            c = parseInt(a.attr("data-rplgsw-parallax-duration"), 10) || d;
                        0 === d && (c = 0);
                        a.transition(c)
                    })
                }
                ...
                onTouchMove: function(b) {
                    ...
                    if (c.gesture.image && 0 !== c.gesture.image.length && (a.allowClick = !1, c.image.isTouched && c.gesture.slide)) {
                        ...
                        var d = c.image.width * c.scale,
                            f = c.image.height * c.scale;
                        if (!(d < c.gesture.slideWidth && f < c.gesture.slideHeight)) {
                            if (c.image.minX = Math.min(c.gesture.slideWidth / 2 - d / 2, 0), c.image.maxX = -c.image.minX, c.image.minY = Math.min(c.gesture.slideHeight / 2 - f / 2, 0), c.image.maxY = -c.image.minY, c.image.touchesCurrent.x = "touchmove" === b.type ? b.targetTouches[0].pageX : b.pageX, c.image.touchesCurrent.y = "touchmove" === b.type ? b.targetTouches[0].pageY : b.pageY, !c.image.isMoved && !c.isScaling)
            ...
            return a.callPlugins = function(b, c, f, e, l, g) {
                ...
                if (a.emitterEventListeners[b])
                    for (d = 0; d < a.emitterEventListeners[b].length; d++) a.emitterEventListeners[b][d](c, f, e, l, g);
    ...
    e.prototype = {
        ...
        device: function() {
            var b = window.navigator.userAgent,
                e = b.match(/(Android);?[\s\/]+([\d.]+)?/),
                c = b.match(/(iPad).*OS\s([\d_]+)/),
                f = b.match(/(iPod)(.*OS\s([\d_]+))?/);
        ...
        support: {
            ...
            flexbox: function() {
                for (var b = document.createElement("div").style, e = "alignItems webkitAlignItems webkitBoxAlign msFlexAlign mozBoxAlign webkitFlexDirection msFlexDirection mozBoxDirection mozBoxOrient webkitBoxDirection webkitBoxOrient".split(" "), c = 0; c < e.length; c++)
                    if (e[c] in b) return !0
            }(),
                    ...
                    if (c)
                        if ("string" == typeof c) {
                            ...
                            if (0 <= g.indexOf("<") && 0 <= g.indexOf(">"))
                                for (f = "div", 0 === g.indexOf("<li") && (f = "ul"), 0 === g.indexOf("<tr") && (f = "tbody"), 0 !== g.indexOf("<td") && 0 !== g.indexOf("<th") || (f = "tr"), 0 === g.indexOf("<tbody") && (f = "table"), 0 === g.indexOf("<option") && (f = "select"), f = document.createElement(f), f.innerHTML = c, g = 0; g < f.childNodes.length; g++) e.push(f.childNodes[g]);
                            else
                                for (c = f || "#" !== c[0] || c.match(/[ .<>:~]/) ? (f || document).querySelectorAll(c) : [document.getElementById(c.split("#")[1])], g = 0; g < c.length; g++) c[g] && e.push(c[g])
                        } else if (c.nodeType || c === window || c === document) e.push(c);
                    else if (0 < c.length && c[0].nodeType)
                        for (g = 0; g < c.length; g++) e.push(c[g]);
                    return new b(e)
                };
            return b.prototype = {
                addClass: function(b) {
                    ...
                    b = b.split(" ");
                    for (var c = 0; c < b.length; c++)
                        for (var e = 0; e < this.length; e++) this[e].classList.add(b[c]);
                    return this
                },
                removeClass: function(b) {
                    b = b.split(" ");
                    for (var c = 0; c < b.length; c++)
                        for (var e = 0; e < this.length; e++) this[e].classList.remove(b[c]);
                    return this
                },
                hasClass: function(b) {
                ...
                toggleClass: function(b) {
                    b = b.split(" ");
                    for (var c = 0; c < b.length; c++)
                        for (var e = 0; e < this.length; e++) this[e].classList.toggle(b[c]);
                    return this
                },
                attr: function(b, f) {
                    if (1 === arguments.length && "string" == typeof b) return this[0] ? this[0].getAttribute(b) : void 0;
                    for (var c = 0; c < this.length; c++)
                        if (2 === arguments.length) this[c].setAttribute(b, f);
                        else
                            for (var e in b) this[c][e] = b[e], this[c].setAttribute(e, b[e]);
                    return this
                },
                ...
                on: function(b, f, g, n) {
                    ...
                    for (b = 0; b < this.length; b++)
                        if ("function" == typeof f || !1 === f)
                            for ("function" == typeof f && (g = f, n = g || !1), l = 0; l < k.length; l++) this[b].addEventListener(k[l], g, n);
                        else
                            for (l = 0; l < k.length; l++) this[b].dom7LiveListeners || (this[b].dom7LiveListeners = []), this[b].dom7LiveListeners.push({
                                listener: g,
                                liveListener: c
                ...
                off: function(b, f, e, g) {
                    ...
                    for (var c = 0; c < b.length; c++)
                        for (var l = 0; l < this.length; l++)
                            if ("function" == typeof f || !1 === f) "function" == typeof f && (e = f, g = e || !1), this[l].removeEventListener(b[c], e, g);
                            else if (this[l].dom7LiveListeners)
                        for (var k = 0; k < this[l].dom7LiveListeners.length; k++) this[l].dom7LiveListeners[k].listener === e && this[l].removeEventListener(b[c], this[l].dom7LiveListeners[k].liveListener, g);
                    return this
                },
                ...
                trigger: function(b, f) {
                    for (var c = 0; c < this.length; c++) {
                        try {
                            var e = new window.CustomEvent(b, {
                                detail: f,
                                bubbles: !0,
                                cancelable: !0
                            })
                ...
                transitionEnd: function(b) {
                    function c(f) {
                        if (f.target === this)
                            for (b.call(this, f), e = 0; e < g.length; e++) k.off(g[e], c)
                    }
                    var e, g = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"],
                        k = this;
                    if (b)
                        for (e = 0; e < g.length; e++) k.on(g[e], c);
                    return this
                },
                width: function() {
                ...
                is: function(c) {
                    ...
                    if ("string" == typeof c) {
                        ...
                        for (f = 0; f < c.length; f++)
                            if (c[f] === this[0]) return !0;
                        return !1
                    }
                    if (c === document) return this[0] === document;
                    if (c === window) return this[0] === window;
                    if (c.nodeType || c instanceof b)
                        for (c = c.nodeType ? [c] : c, f = 0; f < c.length; f++)
                            if (c[f] === this[0]) return !0;
                    return !1
                },
                index: function() {
                ...
                append: function(c) {
                    ...
                    for (e = 0; e < this.length; e++)
                        ...
                        for (g = 0; g < c.length; g++) this[e].appendChild(c[g]);
                    else this[e].appendChild(c);
                    return this
                },
                prepend: function(c) {
                    var e, g;
                    for (e = 0; e < this.length; e++)
                        ...
                        for (g = 0; g < c.length; g++) this[e].insertBefore(c[g], this[e].childNodes[0]);
                    else this[e].insertBefore(c, this[e].childNodes[0]);
                    return this
                },
                insertBefore: function(b) {
                    b = e(b);
                    for (var c = 0; c < this.length; c++)
                        if (1 === b.length) b[0].parentNode.insertBefore(this[c], b[0]);
                        else if (1 < b.length)
                        for (var g = 0; g < b.length; g++) b[g].parentNode.insertBefore(this[c].cloneNode(!0), b[g])
                },
                insertAfter: function(b) {
                    b = e(b);
                    for (var c = 0; c < this.length; c++)
                        if (1 === b.length) b[0].parentNode.insertBefore(this[c], b[0].nextSibling);
                        else if (1 < b.length)
                        for (var g = 0; g < b.length; g++) b[g].parentNode.insertBefore(this[c].cloneNode(!0), b[g].nextSibling)
                },
                next: function(c) {
                ...
                parents: function(b) {
                    for (var c = [], g = 0; g < this.length; g++)
                        for (var k = this[g].parentNode; k;) b ? e(k).is(b) && c.push(k) : c.push(k), k = k.parentNode;
                    return e(e.unique(c))
                },
                find: function(c) {
                    for (var e = [], g = 0; g < this.length; g++)
                        for (var k = this[g].querySelectorAll(c), m = 0; m < k.length; m++) e.push(k[m]);
                    return new b(e)
                },
                children: function(c) {
                    for (var f = [], g = 0; g < this.length; g++)
                        for (var k = this[g].childNodes, m = 0; m < k.length; m++) c ? 1 === k[m].nodeType && e(k[m]).is(c) && f.push(k[m]) : 1 === k[m].nodeType && f.push(k[m]);
...
var WPacTime = WPacTime || {
    ...
    getChatTime: function(b, e) {
        var g = ((new Date).getTime() - b) / 1E3 / 60 / 60,
            k = g / 24;
    ...
    getTime12: function(b, e) {
        b = new Date(b);
        return (b.getHours() % 12 ? b.getHours() % 12 : 12) + ":" + b.getMinutes() + (12 <= b.getHours() ? " PM" : " AM")
    },
...
WPacTime.Messages = {
    ...
    de: {
        ...
        months: function(b) {
            return "vor " + Math.round(b / 30) + " Monaten"
        },
        year: "vor einem Jahr",
        years: function(b) {
    ...
    bg: {
        ...
        minutes: function(b) {
            return "\u043f\u0440\u0435\u0434\u0438 " + Math.round(b) + " \u043c\u0438\u043d\u0443\u0442\u0438"
        },
        hour: "\u043f\u0440\u0435\u0434\u0438 1 \u0447\u0430\u0441",
        hours: function(b) {
...
function _rplg_badge_init(b) {
    ...
    for (var g = document.createElement("div"), k = 0; k < b.length; k++) {
        var p = b[k],
            q = p.getAttribute("data-provider"),
            m = "badge_float_" + q,
            c = sessionStorage.getItem(m),
            f = p.querySelector(".rplg-badge-logo"),
            l = p.querySelector(".rplg-badge2-btn"),
            n = p.querySelector(".rplg-badge2-close"),
            t = p.querySelector(".rplg-form");
...
function _rplg_init_slider(b, e) {
    ...
    var g = b.querySelector(".rplgsw-container"),
        k = {
            loop: !0,
    ...
    k.breakpoints[e.mobileBreakpoint] = {
        slidesPerView: parseInt(e.mobileCount),
        spaceBetween: 10
    };
    k.breakpoints[e.tabletBreakpoint] = {
        slidesPerView: parseInt(e.tabletCount),
        spaceBetween: 20
    };
    k.breakpoints[e.desktopBreakpoint] = {
        slidesPerView: parseInt(e.desktopCount),
        spaceBetween: 30
    };
...
function _rplg_init_flash(b, e) {
    var g = 0,
        ...
        p = !1,
        q = [],
        m = b.querySelector(".rplg-flash-content"),
        c = m.querySelector(".rplg-flash-x"),
        f = m.querySelector(".rplg-flash-card"),
        l = m.querySelector(".rplg-flash-story"),
        n = 1E3 * (e.flash_start || 3),
        t = 1E3 * (e.flash_visible || 5),
        u = 1E3 * (e.flash_invisible || 5);
    document.body.appendChild(b);
    for (var A = b.querySelectorAll(".rplg-form-review"), y = 0; y < A.length; y++) {
        var w = A[y],
            E = w.querySelector(".rplg-stars").getAttribute("data-info").split(",");
...
function _rplg_get_parent(b, e) {
    e = e || "rplg";
    if (0 > b.className.split(" ").indexOf(e))
        for (;
            (b = b.parentElement) && 0 > b.className.split(" ").indexOf(e););
    return b
}
